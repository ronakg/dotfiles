...
let s:N2 = [ '#e4e4e4' , '#0087af' , 252 , 31  ] " Info
let s:N3 = [ '#eeeeee' , '#005f87' , 252 , 24  ] " StatusLine
...
let g:airline#themes#ronakg#palette.normal_modified = {
      \ 'airline_a': [ '#eeeeee' , '#005f87' , 252, 160, '' ] ,
      \ 'airline_c': [ '#eeeeee' , '#005f87' , 252 , 24 , '' ] ,
      \ }
...
let s:I3 = [ '#eeeeee' , '#005f87' , 252 , 24  ] " StatusLine
...
" Inactive:
let s:IA = [ '#585858' , '#e4e4e4' , 252 , 240, '' ]
...
let g:airline#themes#ronakg#palette.tabline = {
            \ 'airline_tab': ['#eeeeee', '#005f87' , 252, 31, '' ],
            \ 'airline_tabfill': ['#eeeeee', '#005f87' , 252, 236, '' ],
            \ 'airline_tabsel': ['#eeeeee', '#005f87' , 240, 254, '' ],
            \ 'airline_tabmod':  [ '#eeeeee' , '#005f87' , 252, 160, '' ],
            \ 'airline_tabmod_unsel':  [ '#eeeeee' , '#005f87' , 252, 167, '' ],
